     ...
     <header class="">
      <nav class="navbar navbar-expand-lg">
        <div class="container">
		          ...
		          <a class="navbar-brand" href="${pageContext.request.contextPath}/open_home_admin_page""><h2>Go' <em>Clinic</em></h2></a>
		          ...
		          <div class="collapse navbar-collapse" id="navbarResponsive">
					            <ul class="navbar-nav ml-auto">
					              <li class="nav-item active">
					                <a class="nav-link" href="${pageContext.request.contextPath}/open_home_admin_page">Home
					              ...
					              <li class="nav-item">
					                <span class="navbar-text textlogin">${name}</span>
					              </li>
					              <li class="nav-item">
