        ...
        <div class="card" style="border-radius: 1rem;">
          <div class="row g-0">
            <div class="col-md-6 col-lg-5 d-none d-md-block">
              <img src="<%=request.getContextPath()%>/img/img_login.jpg"
            ...
            <div class="col-md-6 col-lg-7 d-flex align-items-center">
              <div class="card-body p-4 p-lg-5 text-black">
                ...
                <form action="${pageContext.request.contextPath}/login" method="POST" class="login">
                  ...
                  <h5 class="fw-normal mb-3 pb-3" style="letter-spacing: 2px;">Sign into your account</h5>
                  ...
                  <div class="pt-1 mb-4">
                    <input class="btn btn-dark btn-lg btn-block form-control" type="submit" onclick="return handleSubmit()" value="Login">
                  </div>
                </form>
