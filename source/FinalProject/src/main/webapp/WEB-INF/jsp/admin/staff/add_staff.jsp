      ...
      <div class="col-12 col-lg-9 col-xl-8">
        <div class="card shadow-2-strong card-registration" style="border-radius: 15px;">
          <div class="card-body p-4 p-md-5">
            <h3 class="mb-4 pb-2 pb-md-0 mb-md-5">Add Staff Form</h3>
            <form name="frm" action="${pageContext.request.contextPath}/add_staff_page" method="POST">
              ...
              <div class="d-flex justify-content-end">
				<button class="btn btn-success btn-lg m-1" type="submit" value="submit" onclick="return validate(this.form)">ลงทะเบียน</button>
