        ...
        <div class="col-md-8">
            <div class="card">
                <div class="d-flex flex-row p-2"> <img src="https://i.imgur.com/vzlPPh3.png" width="48">
                    <div class="d-flex flex-column"> <span class="font-weight-bold">Tax Receipt</span> <small>INV-${BuyServices.buyservice_id}</small> </div>
                        ...
                        <tbody>
                            ...
                            <tr class="content">
                                <td class="font-weight-bold">
                                 ...
                                 <td class="font-weight-bold " align="right">ใบเสร็จ/Receipt <br>
                                วันที่  
                                <script>
                                	...
                                	<div class="col-12">
	                                		<div class="d-flex justify-content-end">
												<div>
													...
													<a href="#"><button type="submit" class="btn btn-success btn-lg m-1">พิมพ์ใบเสร็จ</button></a>
												</div>
											</div>
                                	</div>
                                </td>
