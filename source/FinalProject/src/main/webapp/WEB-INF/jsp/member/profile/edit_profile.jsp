      ...
      <div class="col-12 col-lg-9 col-xl-8">
        <div class="card shadow-2-strong card-registration" style="border-radius: 15px;">
          <div class="card-body p-4 p-md-5">
            ...
            <form name="frm" action="${pageContext.request.contextPath}/Edit_Profile" method="POST">
			<input type="hidden" name="person_id" value="${person.person_id}">
			  ...
			  <div class="row">
			  	<div class="col-md-6 mb-4 pb-2">
			  	  <div class="form-outline">
			  	 	<input type="text" name="congenital_disorder" class="form-control form-control-lg" value="${person.congenital_disorder}"/>
                    <label class="form-label" for="congenital_disorder">โรคประจำตัว</label>
			  	  </div>
			  	</div>
			  	<div class="col-md-6 mb-4 pb-2">
			  	  <div class="form-outline">
			  	 	<input type="text" name="drug_allergy" class="form-control form-control-lg" value="${person.drug_allergy}"/>
              ...
              <div class="mt-4 pt-2">
                <button class="btn btn-primary btn-lg" type="submit" onclick="return validate(this.form)" value="บันทึก">บันทึก</button>
