...
<head>
<meta charset="UTF-8">
<title>Edit Appionment Page</title>
        ...
        <div class="card shadow-2-strong card-registration" style="border-radius: 15px;">
          ...
          <h2>Edit Appionment</h2>
            <h3 class="mb-4 pb-2 pb-md-0 mb-md-5"></h3>
              ...
              <!-- ฟอร์ม1 Date -->
              <form id="inner-form" action="${pageContext.request.contextPath}/check_edit_make_appoinment_page" method="GET">
	              	<input type="hidden" name="id" value="${BuyServices.buyservice_id}">
              	<div class="row">
              ...
              <!-- ฟอร์ม2  -->
              <form onsubmit="return confirm('คุณต้องการดำเนินการต่อหรือไม่?')" name="frm" action="${pageContext.request.contextPath}/edit_make_appoinments_page" method="POST">
              <div class="row">
              	<div class="col-md-2 mb-4">
              	<input type="hidden" name="id" value="${BuyServices.buyservice_id}">
              	</div>
                    ...
                    <div class="col-md-4 mb-4">
                    	<select class="form-select" name="select_time">
						  ...
						  <c:forEach items="${Times}" var="time">
						  	<option value="${time}" ${time eq times_select ? 'selected' : ''}>${time}</option>
						  </c:forEach>
						</select>
                    </div>
              </div>
              ...
              <div class="d-flex justify-content-end" >
              	<a href="${pageContext.request.contextPath}/open_list_appionment_page" class="btn btn-danger btn-lg m-1" >ยกเลิก</a>
