...
<head>
<meta charset="UTF-8">
<title>List Appionment Page</title>
<link rel="stylesheet"
	...
	<table id="example" class="table table-striped" style="width:100%">
					...
					<tbody>
						...
						<tr>
							...
							<td><a href="${pageContext.request.contextPath}/open_edit_appoinment_page?id=${BuyServices.buyservice_id}"><button type="submit" class="btn btn-warning text-white" onclick="return confirm('คุณต้องการดำเนินการต่อหรือไม่?')">แก้ไข</button></a></td>
							<td><a href="${pageContext.request.contextPath}/cancel_appointment_staff_page?id=${BuyServices.buyservice_id}"><button type="submit" class="btn btn-danger" onclick="return confirm('คุณต้องการลบการนัดหรือไม่ดำเนินการต่อหรือไม่?')">ยกเลิก</button></a></td>
							<td><a href="${pageContext.request.contextPath}/succeed_appionment_page?id=${BuyServices.buyservice_id}"><button type="submit" class="btn btn-success" onclick="return confirm('ต้องการยืนยันรายการเสร็จสิ้นหรือไม่?')">ตรวจสอบความเรียบร้อย</button></a></td>
						</tr>
						</c:forEach>
