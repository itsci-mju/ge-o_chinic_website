...
public class ListServiceController {
	...
	@RequestMapping(value="/open_services_m_page", method=RequestMethod.GET)
	public ModelAndView LoadListServicesm(HttpServletRequest request) {
		ModelAndView mav = new ModelAndView("member/service/list_service_page");
		List<Services> list_services = sm.getListService();
