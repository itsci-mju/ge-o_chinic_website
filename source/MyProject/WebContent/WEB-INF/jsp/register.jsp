...
<label>${message}</label> 
<form name="frm" method="post" enctype="multipart/form-data" action="${pageContext.request.contextPath}/register">
 ...
 Gender : <input type="radio" name="rdoGender"value="M">male 
 <input type="radio" name="rdoGender" value="F">female</br>
